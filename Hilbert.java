...
public class Hilbert {
    ...
    public static void main(String... args) {
    	  System.out.println("Ingrese un parámetro (entero) n para la elaboración de la curva de Hilbert");
    	  Scanner in = new Scanner(System.in);
    	  int a = in.nextInt();
    	
          System.out.println("Entero n:  " + a);
    	
      
            int n = (1 << a);
            List<Point> points = getPointsForCurve(n);
            System.out.println("Hilbert curve, order=" + a);
